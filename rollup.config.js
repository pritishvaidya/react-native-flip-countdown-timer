...
const standaloneBaseConfig = {
  ...
  input: './src/index.js',
  output: {
    file: 'dist/react-native-flip-countdown-timer.js',
    format: 'umd',
    globals,
...
const standaloneProdConfig = {
  ...
  output: {
    ...
    file: 'dist/react-native-flip-countdown-timer.min.js',
  },
...
const nativeConfig = {
  ...
  output: [
    getCJS({
      file: 'dist/react-native-flip-countdown-timer.cjs.js',
    }),
    getESM({
      file: 'dist/react-native-flip-countdown-timer.esm.js',
    }),
  ],
};
